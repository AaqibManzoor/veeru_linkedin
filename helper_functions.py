...
# the search results are then downloaded as html files in a folder
...
# scrolling down the search pages to load the complete html
...
# counts total htmls to be downloaded 10 results per page
...
# parses the "works at" line in the details 
...
# parse htmls to extract data such as names location etc
